...
namespace BusinessManagementSystem.Controllers
{
    ...
    public class UserApiController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateUser([FromBody] User user)
        {
            ...
            var existingUser = await _context.Users.SingleOrDefaultAsync(p => p.Guid.Equals(user.Guid));
        ...
        {
            //partial delete => we maintain status or isDeleted property and set true or false accordingly
            //hard delete=> we completely remove the data from database.
